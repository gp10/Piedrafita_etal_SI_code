function [nx_basal,ntime,X,Tini,Tend,AllNoDiv] = MonteCarloSimulator_SP_BasalCloneDynamics_CellProlif(rtime,lambda,r,gamma,indiv,tlag,GamShape)
%% Non-Markovian Monte Carlo simulator of Single Progenitor (SP) model dynamics (with historical record of cell type and proliferation status)
...
% tlag = 0.5/7;
% GamShape = 8;
% [nx_basal,ntime,X,Tini,Tend,AllNoDiv] = MonteCarloSimulator_SP_BasalCloneDynamics_CellProlif(rtime,lambda,r,gamma,indiv,tlag,GamShape);
