function [nx_basal,ntime,X,Tini,Tend,AllNoDiv] = MonteCarloSimulator_SCCP_BasalCloneDynamics_CellProlif(rtime,labelSfrac,lambdaS,rS,lambdaP,rP,DeltaP,gamma,indiv,tlagS,GamShapeS,tlagP,GamShapeP)
%% Non-Markovian Monte Carlo simulator of Stem Cell-Committed Progenitor (SC-CP) model dynamics (with historical record of cell type and proliferation status)
...
% tlagP = 0/7;
% GamShapeP = 1;
% [nx_basal,ntime,X,Tini,Tend,AllNoDiv] = MonteCarloSimulator_SCCP_BasalCloneDynamics_CellProlif(rtime,labelSfrac,lambdaS,rS,lambdaP,rP,DeltaP,gamma,indiv,tlagS,GamShapeS,tlagP,GamShapeP);
